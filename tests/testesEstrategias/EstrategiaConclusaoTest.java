...
class EstrategiaConclusaoTest {
	...
	void setUp() {
		...
		this.contCentral.configurarEstrategiaPropostaRelacionada("111111111-0", "CONCLUSAO");
		this.contCentral.configurarEstrategiaPropostaRelacionada("222222222-0", "CONCLUSAO");
		this.contCentral.configurarEstrategiaPropostaRelacionada("333333333-0", "CONCLUSAO");
		this.contCentral.configurarEstrategiaPropostaRelacionada("444444444-0", "CONCLUSAO");
	}
	...
	void pegarPropostaRelacionadaCom1Empate() {
		...
		assertEquals("PLP 1/2013", this.contCentral.pegarPropostaRelacionada("444444444-0"));
		assertTrue(this.contCentral.votarPlenario("PLP 1/2016","GOVERNISTA", "111111111-0,222222222-0,333333333-0,777777777-0"));
		assertEquals("PLP 1/2016", this.contCentral.pegarPropostaRelacionada("444444444-0"));
	}
